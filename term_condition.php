    ...
    <body>
                        ...
                        <div class="col-6">
                            <nav>
                                <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="term_condition.php">Term and Condition</a></li>
                                </ol>
                            </nav>                     
                        </div>

                        <div class="col-6">
                            <h5 class="text-end">Term & Condition</h5>
                        </div>
                    </div> <hr>
        </div>
        ...
        <div class="container border rounded pb-5">
                <div class="row pb-5 pt-4">
                        <div class="col-12 text-center pb-3  category-title">
                ...
                <div class="row ">
                    <div class="col-12">
                        <div class="condition_points p-2 border rounded">
                            <h5>01. Classifiedspot Introduction</h5><hr class="container-fluid">
                    ...
                    <div class="col-12 pt-3">
                        <div class="condition_points p-2 border rounded">
                            <h5>02. Acceptance</h5><hr class="container-fluid">
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam pretium dictum diam vel laoreet. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Integer dictum justo nec lacus porta congue. Phasellus convallis ut urna a lobortis. Vestibulum bibendum quam ligula, ac fringilla mi efficitur sed. Curabitur non augue enim. Sed efficitur semper elit, eget gravida est scelerisque ut. Curabitur non ex lobortis ligula auctor dignissim vel in est. Interdum et malesuada fames ac ante ipsum primis in faucibus. Aliquam vel rutrum tellus, vitae hendrerit libero. Morbi posuere augue at egestas cursus. Curabitur ut leo malesuada nibh facilisis semper vel non justo.</p>
                        </div>
                    </div>
                    ...
                    <div class="col-12 pt-3">
                        <div class="condition_points p-2 border rounded">
                            <h5>03. Conduct</h5><hr class="container-fluid">
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam pretium dictum diam vel laoreet. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Integer dictum justo nec lacus porta congue. Phasellus convallis ut urna a lobortis. Vestibulum bibendum quam ligula, ac fringilla mi efficitur sed. Curabitur non augue enim. Sed efficitur semper elit, eget gravida est scelerisque ut. Curabitur non ex lobortis ligula auctor dignissim vel in est. Interdum et malesuada fames ac ante ipsum primis in faucibus. Aliquam vel rutrum tellus, vitae hendrerit libero. Morbi posuere augue at egestas cursus. Curabitur ut leo malesuada nibh facilisis semper vel non justo.</p>
                        </div>
                    </div>
                    ...
                    <div class="col-12 pt-3">
                        <div class="condition_points p-2 border rounded">
                            <h5>04. Access to the Services</h5><hr class="container-fluid">
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam pretium dictum diam vel laoreet. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Integer dictum justo nec lacus porta congue. Phasellus convallis ut urna a lobortis. Vestibulum bibendum quam ligula, ac fringilla mi efficitur sed. Curabitur non augue enim. Sed efficitur semper elit, eget gravida est scelerisque ut. Curabitur non ex lobortis ligula auctor dignissim vel in est. Interdum et malesuada fames ac ante ipsum primis in faucibus. Aliquam vel rutrum tellus, vitae hendrerit libero. Morbi posuere augue at egestas cursus. Curabitur ut leo malesuada nibh facilisis semper vel non justo.</p>
                        </div>
                    </div>
                    ...
                    <div class="col-12 pt-3">
                        <div class="condition_points p-2 border rounded">
                            <h5>05. No Spam Policy</h5><hr class="container-fluid">
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam pretium dictum diam vel laoreet. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Integer dictum justo nec lacus porta congue. Phasellus convallis ut urna a lobortis. Vestibulum bibendum quam ligula, ac fringilla mi efficitur sed. Curabitur non augue enim. Sed efficitur semper elit, eget gravida est scelerisque ut. Curabitur non ex lobortis ligula auctor dignissim vel in est. Interdum et malesuada fames ac ante ipsum primis in faucibus. Aliquam vel rutrum tellus, vitae hendrerit libero. Morbi posuere augue at egestas cursus. Curabitur ut leo malesuada nibh facilisis semper vel non justo.</p>
                        </div>
                    </div>
                    ...
                    <div class="col-12 pt-3">
                        <div class="condition_points p-2 border rounded">
                            <h5>06. User Submissions</h5><hr class="container-fluid">
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam pretium dictum diam vel laoreet. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Integer dictum justo nec lacus porta congue. Phasellus convallis ut urna a lobortis. Vestibulum bibendum quam ligula, ac fringilla mi efficitur sed. Curabitur non augue enim. Sed efficitur semper elit, eget gravida est scelerisque ut. Curabitur non ex lobortis ligula auctor dignissim vel in est. Interdum et malesuada fames ac ante ipsum primis in faucibus. Aliquam vel rutrum tellus, vitae hendrerit libero. Morbi posuere augue at egestas cursus. Curabitur ut leo malesuada nibh facilisis semper vel non justo.</p>
                        </div>
                    </div>
                    ...
                    <div class="col-12 pt-3">
                        <div class="condition_points p-2 border rounded">
                            <h5>07. Privacy Policy</h5><hr class="container-fluid">
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam pretium dictum diam vel laoreet. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Integer dictum justo nec lacus porta congue. Phasellus convallis ut urna a lobortis. Vestibulum bibendum quam ligula, ac fringilla mi efficitur sed. Curabitur non augue enim. Sed efficitur semper elit, eget gravida est scelerisque ut. Curabitur non ex lobortis ligula auctor dignissim vel in est. Interdum et malesuada fames ac ante ipsum primis in faucibus. Aliquam vel rutrum tellus, vitae hendrerit libero. Morbi posuere augue at egestas cursus. Curabitur ut leo malesuada nibh facilisis semper vel non justo.</p>
                        </div>
                    </div>
